...
var DatatableResponsive = function() {
    ...
    var _componentDatatableResponsive = function() {
        ...
        $('.datatable-disease-column-controlled').DataTable({
            responsive: {
                details: {
                    type: 'column'
                }
        ...
        // Control position
        $('.datatable-disease-control-right').DataTable({
            responsive: {
                details: {
                    type: 'column',
                    target: -1
        ...
        $('.datatable-disease-row-control').DataTable({
            responsive: {
                details: {
                    type: 'column',
                    target: 'tr'
