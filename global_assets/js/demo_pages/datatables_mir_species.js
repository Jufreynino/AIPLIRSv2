...
var DatatableResponsive = function() {
    ...
    var _componentDatatableResponsive = function() {
        ...
        $('.datatable-species-column-controlled').DataTable({
            responsive: {
                details: {
                    type: 'column'
                }
        ...
        // Control position
        $('.datatable-species-control-right').DataTable({
            responsive: {
                details: {
                    type: 'column',
                    target: -1
        ...
        $('.datatable-species-row-control').DataTable({
            responsive: {
                details: {
                    type: 'column',
                    target: 'tr'
