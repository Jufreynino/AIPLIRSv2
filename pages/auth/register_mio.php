						...
						<div class="card">
							<div class="card-body">
								<ul class="nav nav-tabs nav-tabs-highlight nav-justified">
									...
									<li class="nav-item"><a href="register_mio.php" class="nav-link active" >Meat Inspection Officer</a></li>
								...
								<div class="tab-content">
									...
									<div class="tab-pane fade  show active" id="highlighted-justified-tab2">
									<!-- Registration form -->
				<form method="POST" class="flex-fill">
							...
							<div class="card mb-0">
								...
								<div class="card-body">
									<div class="text-center mb-3">
										<h1 class="mb-0">Meat Inspection Officer Account Registration</h1>
						...
						<?php echo add_mio_account_posms() ?>
                                    ...
                                    <div class="row">
										...
										<div class="col-md-4">
											<div class="form-group form-group-feedback form-group-feedback-right">
												<input type="password" class="form-control" name="confirm_password" id="c_password" placeholder="Confirm Password">
												<div class="form-control-feedback">
													<i class="icon-exclamation text-muted"></i>
												</div>
											</div>
...
<script>
			$(document).ready(function(){
					$( "#btn_add_mio" ).click(function(event) {
					event.preventDefault();
						var employee_code = $('#employee_code').val();
						var firstname = $('#firstname').val();
						var lastname = $('#lastname').val();
						var text_content = $('#region_content').val();
						var email = $('#email').val();
						...
						$.ajax({
							...
							success: function(data) {
								...
								if(data =='success')
								{
									$('#btn_add_mio').prop("disabled", true);
									Swal.fire({
										title: 'Success',
