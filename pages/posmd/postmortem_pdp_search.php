							...
							<ul class="nav nav-group-sub" data-submenu-title="Menu levels">
								...
								<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
									...
									<ul class="nav nav-group-sub">
										...
										<li class="nav-item"><a href="postmortem_pdp.php" class="nav-link active"><i class="icon-files-empty"></i>Postmortem</a></li>
					...
					<div class="col-xl-12">
						<div class="card">
							...
							<div class="card-header header-elements-inline" style="background-color:#26a69a; color: #ffffff;">
								<h5 class="card-title" style=" font-weight:bold !important;">Diseases and Conditions during Postmortem Inspection in Poultry Dressing Plant </h5>
                                                ...
                                                <div class="card-body">
                                                	<br>
                                                                            ...
                                                                            <table style="width: 100%; margin-top:20px;" class="table  table-bordered table-striped ">
                                                                                ...
                                                                                <tbody>
                                                                                    <?php echo show_postmortem_pdp_disease_search() ?>
