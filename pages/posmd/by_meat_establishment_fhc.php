					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline" style="background-color:#324147; color:white;">
									<h4 class="card-title">Meat Establishments<p style="font-size:15px;">Fit for Human Consumption </p></h4>
								</div>
<br>
<br>
							<div class="card-body py-0">
								<div class="row">
									...
									<div class="col-md-6">
										<form method="GET" action="by_meat_establishment_fhc_report.php">
