				...
				<div class="row">
					<div class="col-xl-12">
						<div class="card">
							...
							<h4 class="card-title" style="font-weight:bold !important;">Antemortem Condemnation Report</h4><br>
							</div>
							<br>
							<form method="POST" >
							...
							<div class="card-body py-0">				
								<div class="row"> 
									<div class="col-md-12">
												<table class="table datatable-condemned-disease table-striped table-bordered" >
													...
													<tbody>
														<?php echo disease_report_antmortem_daily() ?>
													</tbody>
												</table>
									</div>
								</div>	
