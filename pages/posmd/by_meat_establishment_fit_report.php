						...
						<div class="card  border-top-2 border-top-slate border-bottom-2 border-bottom-slate rounded-0" style="border-radius: 0;">
							<div class="card-body ">
								<div class="text-center">
									<h1  style=" font-weight:bold !important; ">Meat Establishments</h1>
									<h2  style=" font-weight:bold !important; ">Fit for Slaughter</h2>
																	...
																	<div class="col-md-12 text-right">
																		<div class="form-group">
																			<label class="col-form-label text-right"></label>
																				<button type="submit" name="search_me_data_fit_for_slaughter" class="btn btn-primary">Filter</button>
																		</div>
																	</div>
																	</form>
														</div>
							   ...
							   <table class="table table-bordered table-striped datatable-responsive">
                                    <thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;">
                                        <tr class="text-center">
                                            <th rowspan="2" class="sticky-col first-col" style="  background-color:white !important; color:black; font-weight:bold;">Meat Establishment</th>
                                            <th rowspan="2" style="  background-color:white !important; color:black; font-weight:bold;">Region</th>
                                            <th rowspan="2" style="  background-color:white !important; color:black; font-weight:bold;">Province</th>
                                            <th rowspan="2" style="  background-color:white !important; color:black; font-weight:bold;">City</th>
                                            <th rowspan="2" style="  background-color:white !important; color:black; font-weight:bold;">Type</th>
                                            <th rowspan="2" style="  background-color:white !important; color:black; font-weight:bold;">LTO Number</th>
											<th colspan="2" style="font-weight:bold !important; background-color: #3bb8d5; color:white;">HOG </th>
											<th  colspan="2" style="font-weight:bold !important; background-color: #eb5555fa; color:white;">CHICKEN</th>
											<th  colspan="2" style="font-weight:bold !important; background-color: #a277f7; color:white;">CATTLE</th>
											<th  colspan="2" style="font-weight:bold !important; background-color: #77a4f7; color:white;">CARABAO</th>
										
											<th  colspan="2" style="font-weight:bold !important; background-color: #7fc998; color:white;">HORSE</th>
											<th  colspan="2" style="font-weight:bold !important; background-color: #2cb1a4; color:white;">GOAT</th>
											<th  colspan="2" style="font-weight:bold !important; background-color: #f7a677; color:white;">SHEEP</th>
											<th  colspan="2" style="font-weight:bold !important; background-color: #4faf44; color:white;">DUCK</th>
											<th  colspan="2" style="font-weight:bold !important; background-color: #e77393; color:white;">PIGEON</th>
											<th  colspan="2" style="font-weight:bold !important; background-color: #ba7abb; color:white;">OSTRICH </th>
											<th  colspan="2" style="font-weight:bold !important; background-color: #f7a677; color:white;">CROCODILE </th>
										</tr>
										<tr>
									...
									<tbody>
										...
										<?php echo me_slaughter_report_posmd() ?>
