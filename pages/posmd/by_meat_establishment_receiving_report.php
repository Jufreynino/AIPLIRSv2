									...
									<table class="table table-bordered table-striped datatable-responsive">
										<thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;">
											<tr class="text-center">
												<th rowspan="2" class="sticky-col first-col" style=" font-weight:bold !important; background-color:white !important; color:black;">Meat Establishment</th>
												<th  style=" font-weight:bold !important; background-color:white !important; color:black;" rowspan="2">Region</th>
												<th  style=" font-weight:bold !important; background-color:white !important; color:black;" rowspan="2">Province</th>
												<th  style=" font-weight:bold !important; background-color:white !important; color:black;" rowspan="2">City</th>
												<th  style=" font-weight:bold !important; background-color:white !important; color:black;" rowspan="2">Type</th>
												<th  style=" font-weight:bold !important; background-color:white !important; color:black;" rowspan="2">LTO Number</th>
										...
										<tbody>
											...
											<?php echo me_receiving_report_posmd() ?>
