										...
										<div class="card-body">
											<div class="d-md-flex">
												<ul class="nav nav-tabs nav-tabs-vertical flex-column mr-md-3 wmin-md-300 mb-md-0 border-bottom-0">
													...
													<a href="by_region_summary_report.php?from=<?php echo $_GET['from'] ?>&to=<?php echo $_GET['to'] ?>&region=
														<?php echo $_GET['region'] ?>&province=<?php echo $_GET['province'] ?>" class="btn btn-primary">Back</a>
												</ul>
												<div class="tab-content" style=" width: 100% !important;">
													<div class="tab-pane fade show active" id="vertical-left-tab1">
														 	 	...
														 	 	<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo province_summary_ffs_suspect_posmd() ?>
								                                    </tbody>
								                                </table>
													...
													<div class="tab-pane fade" id="vertical-left-tab2">
																...
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo province_summary_ffs_reject_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
													<div class="tab-pane fade" id="vertical-left-tab3">
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo province_summary_ffs_condemned_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
												</div>
