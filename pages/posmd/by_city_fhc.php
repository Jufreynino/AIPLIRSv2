					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline" style="background-color:#324147; color:white;">
								<h4 class="card-title">Municipality / City<p style="font-size:15px;">Fit for Human Consumption</p></h4>
							...
							<div class="card-body py-0">
								<div class="row">
									...
									<div class="col-md-6">
										<form method="GET" action="by_city_fhc_report.php">
											...
											<div class="form-group row">
					                        	...
					                        	<div class="col-lg-8">
					                        		  <select id="region"  class="form-control  js-example-basic-single" onchange="document.getElementById('region_content').value=this.options[this.selectedIndex].text"  id="region"  required ></select>
