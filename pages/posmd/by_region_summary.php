					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline" style="background-color:#324147; color:white;">
									<h4 class="card-title">Regional<p style="font-size:15px;">Meat Inspection Summary Report</p></h4>
								</div>
								<br>
							<div class="card-body py-0">
								<div class="row">
									...
									<div class="col-md-6">
										<form method="GET" action="by_region_summary_report.php">
											...
											<div class="form-group row">
					                        	...
					                        	<div class="col-lg-8">
					                        		  <select id="region" onchange="document.getElementById('text_content').value=this.options[this.selectedIndex].text" class="form-control  js-example-basic-single" id="region" required ></select>
															<input type="hidden" name="region" id="text_content" value="" required>
					                            </div>
					                        </div>
