				...
				<div class="row">
					<div class="col-xl-12">
						<div class="card">
							...
							<h4 class="card-title " style=" font-weight:bold !important;">Dashboard</h4>
							...
							<div class="row">
								<div class="col-md-4">
									<div class="card" style="border:1px solid black; border-radius: 0;">
										<div class="card-header" style="background-color:#007cd5; color:white;">
										<h4 class="card-title text-center" style=" font-weight:bold !important;">Total Number of Animals Received<p style="font-size:15px;"> January 1 -  <?php echo date('F d') ?>, <?php echo date('Y') ?></p></h4>
										</div>
											<table class="table table-bordered">
												<tr>
													<th  class="text-center" style=" font-weight:bold !important;">Species</th>
													<th class="text-center" style=" font-weight:bold !important;">Total Head Count</th>
													<th class="text-center" style=" font-weight:bold !important;">Total Live Weight (kg)</th>
												</tr>
												<?php echo national_total_received() ?>
											</table>	
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="card" style="border:1px solid black; border-radius: 0;">
										<div class="card-header" style="background-color:#007cd5; color:white;">
										<h4 class="card-title text-center" style=" font-weight:bold !important;">Total Number of Animals Slaughtered<p style="font-size:15px;"> January 1 -  <?php echo date('F d') ?>, <?php echo date('Y') ?></p></h4>
										</div>
											<table class="table table-bordered">
												<tr>
													<th  class="text-center" style=" font-weight:bold !important;">Species</th>
												...
												<?php echo national_total_slaughtered() ?>
								...
								<div class="col-md-4">
									<div class="card" style="border:1px solid black; border-radius: 0;">
										<div class="card-header" style="background-color:#007cd5; color:white;">
										<h4 class="card-title text-center" style=" font-weight:bold !important;">Total Volume of Meat Fit For Human Consumption<p style="font-size:15px;"> January 1 -  <?php echo date('F d') ?>, <?php echo date('Y') ?></p></h4>
										</div>
											<table class="table table-bordered">
												<tr>
													<th  class="text-center" style=" font-weight:bold !important;"> Species</th>
													<th class="text-center" style=" font-weight:bold !important;">Total Head Count</th>
													<th  class="text-center" style=" font-weight:bold !important;">Meat Type</th>
													<th class="text-center" style=" font-weight:bold !important;">Total Dressed Weight (kg)</th>
												</tr>
												<?php echo national_total_fhc() ?>
								...
								<!-- <div class="col-md-12">
									<div class="card" style="border:1px solid black; border-radius: 0;">
										<div class="card-header" style="background-color:#324147; color:white;">
										<h4 class="card-title text-center">Total Volume of Meat Fit For Human Consumption<p style="font-size:15px;"> January 1 -  <?php echo date('F d') ?>, <?php echo date('Y') ?></p></h4>
										</div>
										<?php echo charts() ?>
						...
						<br>
								...
								<div class="col-xl-3 col-lg-6 text-center">
                                        <div class="card bg-indigo-700">
                                            <div class="card-statistic-3 p-4">
                                                ...
                                                <div class="row ">
	                                            	<div class="col-md-6">
	                                            		<p style="font-size: 15px;">Heads</p>
	                                               			 <p style="font-size: 15px;"><?php echo count_daily_slaughthered_heads() ?></p>
	                                            	</div>
	                                            	<div class="col-md-6">
	                                            		<p style="font-size: 15px;">Weight</p>
	                                               			 <p style="font-size: 15px;"><?php echo count_daily_slaughthered_weight() ?></p>
	                                            	</div>
                                                </div>

                                                    <h5 style="text-align: center; margin-bottom: -5px ; font-size: 12px;  ">Daily Slaughtered</h5>
                                            ...
                                            <div class="card-statistic-3 p-4">
                                                ...
                                                <div class="row ">
	                                            	<div class="col-md-12 text-center">
	                                            		<p style="font-size: 15px;">All Regions</p>
	                                               			 <p style="font-size: 15px;"><?php echo count_accredited_meat_establishment() ?></p>
	                                            	</div>
                                                </div>
                                                    <h5 style="text-align: center; margin-bottom: -5px ; font-size: 12px;">Accredited Meat Establishments</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-lg-6">
                                            ...
                                            <div class="card-statistic-3 p-4">
                                                <div class="card-icon card-icon-large"><i class="fas fa-ticket-alt"></i></div>
	                                                <div class="row ">
		                                            	<div class="col-md-12 text-center">
		                                            		<p style="font-size: 15px;">All Regions</p>
		                                               			 <p style="font-size: 15px;"><?php echo count_meat_inspection_officer() ?></p>
		                                            	</div>
	                                                </div>
	                                                    <h5 style="text-align: center; margin-bottom: -5px ; font-size: 12px;">Registered Meat Inspection Officer</h5>
                                            </div>
                                        </div>
                                    </div> -->
							...
							<!-- 	<div class="col-xl-3 col-lg-6">
									<div class="card " style="background-color:#263238; color:white;">
										<div class="card-statistic-3 p-4">
											<div class="card-icon card-icon-large"><i class="fas fa-shopping-cart"></i></div>
											<div class="mb-4">
												<h5 class="card-title mb-0 text-center" style="margin-bottom:-20px !important;">Chicken</h5>
											</div>
												<div class="row">
													<div class="col-md-6">
														Heads
														<h5 class="text-center"><?php echo count_chicken_slaughtered_region_heads() ?></h5>
													</div>
													<div class="col-md-6">
														Weight
														<h5 class="text-center"><?php echo count_chicken_slaughtered_region_weight() ?></h5>
													</div>
												</div>				
										</div>
									</div>
								...
								<div class="col-xl-3 col-lg-6">
									<div class="card" style="background-color:#263238; color:white;">
										<div class="card-statistic-3 p-4">
											<div class="card-icon card-icon-large"><i class="fas fa-shopping-cart"></i></div>
											<div class="mb-4">
												<h5 class="card-title mb-0 text-center" style="margin-bottom:-20px !important;">Cattle</h5>
											</div>
												<div class="row">
													<div class="col-md-6">
														Heads
								...
								<div class="col-xl-3 col-lg-6">
									<div class="card" style="background-color:#263238; color:white;">
										<div class="card-statistic-3 p-4">
											<div class="card-icon card-icon-large"><i class="fas fa-shopping-cart"></i></div>
											<div class="mb-4">
												<h5 class="card-title mb-0 text-center" style="margin-bottom:-20px !important;">Carabao</h5>
											</div>
												<div class="row">
													<div class="col-md-6">
														Heads
								...
								<div class="col-xl-3 col-lg-6">
									<div class="card" style="background-color:#263238; color:white;">
										<div class="card-statistic-3 p-4">
											<div class="card-icon card-icon-large"><i class="fas fa-shopping-cart"></i></div>
											<div class="mb-4">
												<h5 class="card-title mb-0 text-center" style="margin-bottom:-20px !important;">Swine</h5>
											</div>
												<div class="row">
													<div class="col-md-6">
														Heads
								...
								<div class="col-xl-3 col-lg-6">
									<div class="card" style="background-color:#263238; color:white;">
										<div class="card-statistic-3 p-4">
											<div class="card-icon card-icon-large"><i class="fas fa-shopping-cart"></i></div>
											<div class="mb-4">
												<h5 class="card-title mb-0 text-center" style="margin-bottom:-20px !important;">Goat</h5>
											</div>
												<div class="row">
													<div class="col-md-6">
														Heads
								...
								<div class="col-xl-3 col-lg-6">
									<div class="card" style="background-color:#263238; color:white;">
										<div class="card-statistic-3 p-4">
											<div class="card-icon card-icon-large"><i class="fas fa-shopping-cart"></i></div>
											<div class="mb-4">
												<h5 class="card-title mb-0 text-center" style="margin-bottom:-20px !important;">Duck</h5>
											</div>
												<div class="row">
													<div class="col-md-6">
														Heads
								...
								<div class="col-xl-3 col-lg-6">
									<div class="card" style="background-color:#263238; color:white;">
										<div class="card-statistic-3 p-4">
											<div class="card-icon card-icon-large"><i class="fas fa-shopping-cart"></i></div>
											<div class="mb-4">
												<h5 class="card-title mb-0 text-center" style="margin-bottom:-20px !important;">Horse</h5>
											</div>
												<div class="row">
													<div class="col-md-6">
														Heads
								...
								<div class="col-xl-3 col-lg-6">
									<div class="card" style="background-color:#263238; color:white;">
										<div class="card-statistic-3 p-4">
											<div class="card-icon card-icon-large"><i class="fas fa-shopping-cart"></i></div>
											<div class="mb-4">
												<h5 class="card-title mb-0 text-center" style="margin-bottom:-20px !important;">Sheep</h5>
											</div>
												<div class="row">
													<div class="col-md-6">
														Heads
								...
								<div class="col-xl-3 col-lg-6">
									<div class="card" style="background-color:#263238; color:white;">
										<div class="card-statistic-3 p-4">
											<div class="card-icon card-icon-large"><i class="fas fa-shopping-cart"></i></div>
											<div class="mb-4">
												<h5 class="card-title mb-0 text-center" style="margin-bottom:-20px !important;">Ostrich</h5>
											</div>
												<div class="row">
													<div class="col-md-6">
														Heads
								...
								<div class="col-xl-3 col-lg-6">
									<div class="card" style="background-color:#263238; color:white;">
										<div class="card-statistic-3 p-4">
											<div class="card-icon card-icon-large"><i class="fas fa-shopping-cart"></i></div>
											<div class="mb-4">
												<h5 class="card-title mb-0 text-center" style="margin-bottom:-20px !important;">Corcodile</h5>
											</div>
												<div class="row">
													<div class="col-md-6">
														Heads
