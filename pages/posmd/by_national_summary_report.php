						...
						<div class="card  border-top-2 border-top-slate border-bottom-2 border-bottom-slate rounded-0" style="border-radius: 0;">
							<div class="card-body ">
										...
										<?php } ?>
                                            ...
                                            <h2 > Meat Inspection Report Summary</h2>

                                            <p style="font-size:15px; margin-top:10px;"><?php if(isset($_POST['search_national_data_summary'])) { ?>For the period of <?php echo date('F d, Y', strtotime($_POST['from'])); ?> to <?php echo date('F d, Y', strtotime($_POST['to'])); }?></p>
															...
															<div class="col-md-12 text-right">
																<div class="form-group">
																	<label class="col-form-label text-right"></label>
																		<button type="submit" name="search_national_data_summary" class="btn btn-primary">Filter</button>
																</div>
															</div>
												</div>
											</div>
											...
											<tr class="text-center">
													<?php if(isset($_POST['search_national_data_summary'])){ ?>
            												<?php if(empty($_POST['region']) && empty($_POST['province'])) { ?>
																<th  style="font-weight:bold !important;" rowspan="2">Species</th>
															<?php } else if(empty($_POST['province'])) { ?>
																<th  style="font-weight:bold !important;" rowspan="2">Region</th>
																<th  style="font-weight:bold !important;" rowspan="2">Species</th>
															<?php } else if(empty($_POST['city'])) { ?>
																<th  style="font-weight:bold !important;" rowspan="2">Region</th>
																<th  style="font-weight:bold !important;" rowspan="2">Province</th>
																<th  style="font-weight:bold !important;" rowspan="2">Species</th>
															<?php }else{?>
																<th  style="font-weight:bold !important;" rowspan="2">Region</th>
																<th  style="font-weight:bold !important;" rowspan="2">Province</th>
																<th  style="font-weight:bold !important;" rowspan="2">City</th>
																<th  style="font-weight:bold !important;" rowspan="2">Species</th>

															<?php }  ?>

													<?php } ?>
													<th  style="font-weight:bold !important;" colspan="2">Receiving of Animals</th>
													<th  style="font-weight:bold !important;" colspan="2">Fit for Slaughter</th>
													<th  style="font-weight:bold !important;" colspan="3">Fit for Human Consumption</th>
												</tr>
												<tr class="text-center">
													<th  style="font-weight:bold !important;">Total Head Count</th>
													<th  style="font-weight:bold !important;">Total Live Weight (kg)</th>
													<th  style="font-weight:bold !important;">Total Head Count</th>
													<th  style="font-weight:bold !important;">Total Live Weight (kg)</th>
													<th  style="font-weight:bold !important;">Total Head Count</th>
													<th  style="font-weight:bold !important;">Meat Type</th>
													<th  style="font-weight:bold !important;">Total Dressed Weight (kg)</th>
												</tr>
											</thead>
											<tbody>
												<?php echo national_summary_report_posmd() ?>
											</tbody>
										</table>
