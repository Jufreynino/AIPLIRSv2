					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline" style="background-color:#324147; color:white;">
									<h4 class="card-title">Province<p style="font-size:15px;">Meat Inspection Report Summary</p></h4>
								</div>
								<br>
							<div class="card-body py-0">
								<div class="row">
									...
									<div class="col-md-6">
										<form method="GET" action="by_city_summary_report_species.php">
											...
											<div class="form-group row">
					                        	...
					                        	<div class="col-lg-8">
					                        		  <select id="region"  class="form-control  js-example-basic-single"  onchange="document.getElementById('region_content').value=this.options[this.selectedIndex].text"  id="region_content"  required ></select>
															<input type="hidden" name="region" id="region_content" value="" required>
					                            </div>
					                        </div>
											...
											<div class="form-group row">
					                        	...
					                        	<div class="col-lg-8">
					                        		  <select id="province" onchange="document.getElementById('text_content').value=this.options[this.selectedIndex].text" id="province" class="form-control  js-example-basic-single" required ></select>
					                        ...
					                        <div class="form-group row">
					                        	<label class="col-form-label col-lg-4 text-right">Municipality / City</label>
					                        	<div class="col-lg-8">
 												...
 												<select id="city" onchange="document.getElementById('city_text').value=this.options[this.selectedIndex].text" class="form-control  js-example-basic-single" id="city" required ></select>
															<input type="hidden" name="city" id="city_text" value="" required />
					                            </div>
					                        </div>
