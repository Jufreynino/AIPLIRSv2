				...
				<div class="row">
					<div class="col-xl-12">
						<div class="card">
							...
							<h4 class="card-title">List of POSMD Accounts</h4>
									...
									<div class="form-check form-check-right form-check-switchery form-check-switchery-sm">
										<label class="form-check-label">
											...
											<input type="checkbox" class="form-input-switchery" checked data-fouc>
                                              ...
                                              <button type="button" class="btn bg-primary-800 btn-flat" data-toggle="modal" data-target="#modal_theme_primary">Add POSMD Account </button>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header bg-primary">
                                                                <h6 class="modal-title">Add POSMD Account</h6>
                                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                                            <?php echo add_posmd_account() ?>
                                                        ...
                                                        <form method="POST">
                                                                <div class="form-group">
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <input type="text" placeholder="Employee Code" name="emp_code" class="form-control" required>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit" name="btn_add_posmd" class="btn bg-primary">Save changes</button>
                                                            </div>
                                                        </div>
                                                        </form>
                                            <br><br><br><br><br><br>
