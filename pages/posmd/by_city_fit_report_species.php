							...
							<div class="col-md-12">
								<div class="card " style="border-radius: 0;">
                                    ...
                                    <div class="text-center">
                                            ...
                                            <h1>Meat Inspection Summary Report</h1>
										...
										<div class="card-body">
											<div class="d-md-flex">
												<ul class="nav nav-tabs nav-tabs-vertical flex-column mr-md-3 wmin-md-300 mb-md-0 border-bottom-0">
													...
													<li class="nav-item" style="font-size: 15px;"><a href="#vertical-left-tab1" class="nav-link active" data-toggle="tab"><i class="icon-menu7 mr-2"></i> <b> Suspected / ON hold </b></a></li>
													<li class="nav-item "  style="font-size: 15px;"><a href="#vertical-left-tab2" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> <b> Rejected</b></a></li>
													<li class="nav-item "  style="font-size: 15px;"><a href="#vertical-left-tab3" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> <b> Condemned</b></a></li>
													<a href="by_city_summary_report_species.php?from=<?php echo $_GET['from'] ?>&to=<?php echo $_GET['to'] ?>&region=
														<?php echo $_GET['region'] ?>&province=<?php echo $_GET['province'] ?>&city=<?php echo $_GET['city'] ?>" class="btn btn-primary">Back</a>
												</ul>
												<div class="tab-content" style=" width: 100% !important;">
													<div class="tab-pane fade show active" id="vertical-left-tab1">
														 	 	...
														 	 	<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo city_summary_ffs_suspect_posmd() ?>
								                                    </tbody>
								                                </table>
													...
													<div class="tab-pane fade" id="vertical-left-tab2">
																...
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo city_summary_ffs_reject_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
													<div class="tab-pane fade" id="vertical-left-tab3">
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo city_summary_ffs_condemned_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
												</div>
