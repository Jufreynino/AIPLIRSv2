                                        ...
                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
                                            <div class="card-statistic-3 p-4">
                                                ...
                                                <table class="table table-bordered" style="margin-top:-25px;">
													...
													<tr>
                                                <?php echo fetch_all_low_antemortem_suspected() ?>
													</tr>  
                                        ...
                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
                                            <div class="card-statistic-3 p-4">
                                                ...
                                                <table class="table table-bordered" style="margin-top:-25px;">
													...
													<tr>
                                                <?php echo fetch_all_low_antemortem_rejected() ?>
													</tr>  
                                        ...
                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
                                            <div class="card-statistic-3 p-4">
                                                ...
                                                <table class="table table-bordered" style="margin-top:-25px;">
													...
													<tr>
                                                <?php echo fetch_all_low_antemortem_condemned() ?>
													</tr>  
                                                </table>
                                            </div>
                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_low_postmortem_carcass() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_low_postmortem_lung() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_low_postmortem_liver() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_low_postmortem_heart() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_low_postmortem_intestine() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_low_postmortem_feet() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_low_postmortem_kidneys() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_low_postmortem_spleen() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_low_postmortem_trimmings() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
