						...
						<div class="accordion-sortable" id="accordion-controls">
							<div class="card">
								<div class="card-header   bg-info text-white header-elements-inline">
									<h6 class="card-title">
										<a data-toggle="collapse" class="text-white collapsed" style=" font-weight:bold !important;" href="#accordion-controls-group1">Current Meat Inspection Officer Assigned</a>
									</h6>
												...
												<table class="table table-bordered table-striped  datatable-responsive" >
													<thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;">
														<tr class="text-center">
															<th style=" font-weight:bold !important;">Employee Number</th>
															<th style=" font-weight:bold !important;">Name</th>
															<th style=" font-weight:bold !important;">Email</th>
															<th style=" font-weight:bold !important;">Contact</th>
														</tr>
													</thead>
													<tbody>
														<?php echo me_assigned_mio()?>
							...
							<div class="card">
								<div class="card-header   bg-primary text-white header-elements-inline">
									<h6 class="card-title">
										<a data-toggle="collapse" class="text-white collapsed" style=" font-weight:bold !important;" href="#accordion-controls-group2">Previous Meat Inspection Officer Assigned</a>
									</h6>
								...
								<div id="accordion-controls-group2" class="collapse show" data-parent="#accordion-controls">
									<div class="card-body">
												<table class="table table-bordered table-striped  datatable-responsive" >
													<thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;">
														<tr class="text-center">
													...
													<tbody>
														<?php echo me_assigned_mio_previous()?>
