						...
						<div class="card  border-top-2 border-top-slate border-bottom-2 border-bottom-slate rounded-0" style="border-radius: 0;">
							<div class="card-body ">
								<div class="text-center">
									<h1  style="font-weight:bold !important;"> Meat Establishment</h1>
						...
						<div class="card  border-top-2 border-top-slate border-bottom-2 border-bottom-slate rounded-0">
							<div class="card-body py-0">
							   ...
							   <table class="table table-bordered table-striped datatable-responsive">
                                    <thead style="padding:10px !important; height:20px !important; margin:20px !important;  text-align:center; border:1px solid #bdb8b8; background-color:#1d2328; color:white;">
                                        <tr>
                                            <th class="sticky-col first-col" style="  background-color:white !important; text-align:center; color:black; font-weight:bold !important;" >Meat Establishment</th>
                                        
                                            <th  style="font-weight:bold !important; background-color:white !important;  text-align:center; color:black;">Region</th>
                                            <th  style="font-weight:bold !important; background-color:white !important; color:black;">Province</th>
                                            <th  style="font-weight:bold !important; background-color:white !important; color:black;">City</th>
                                            <th  style="font-weight:bold !important; background-color:white !important; color:black;">Type</th>
                                            <th  style="font-weight:bold !important; background-color:white !important; color:black;">LTO Number</th>
