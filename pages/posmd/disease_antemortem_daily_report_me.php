			...
			<div class="sidebar-content">
				<div class="sidebar-user">
					<div class="card-body">
						<div class="media">
							<div class="mr-3">
								<a href="#"><img class=" text-warning-400  img-circle" width="38" height="38"  src="../../global_assets/images/download.png"></i></a>
							</div>
							<div class="media-body">
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline" style="background-color:#324147; color:white;">
								<?php echo disease_report_postmortem_daily_selected_disease_details() ?>
								...
								<div class="row"> 
									<div class="col-md-12">
										<table class="table datatable-basic table-bordered" >
											...
											<tbody>
												<?php echo disease_report_antemortem_daily_selected_disease_me() ?>
											</tbody>
										</table>
									</div>
								</div>	
