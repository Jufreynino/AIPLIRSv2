			...
			<div class="sidebar-content">
				...
				<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu  nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item">
									<a href="by_national_summary_report.php" class="nav-link active">National Data
									</a>
								</li>
							...
							<div class="col-md-12">
								<div class="card " style="border-radius: 0;">
                                    ...
                                    <div class="text-center">
                                            ...
                                            <h1>Fit for Human Consumption<p/h1>
                                            ...
                                            <h1 ><b> Philippines</b></h1>
                                            <h3 class="text-primary">  National Data</h3>
                                            <h3 class="text-danger">Species: <b> <?php echo $_GET['species']; ?></b></h3>
										...
										<div class="card-body">
											<div class="d-md-flex">
												<ul class="nav nav-tabs nav-tabs-vertical flex-column mr-md-3 wmin-md-300 mb-md-0 border-bottom-0">
													...
													<li class="nav-item" style="font-size: 15px;"><a href="#vertical-left-tab1" class="nav-link active" data-toggle="tab"><i class="icon-menu7 mr-2"></i> <b> Carcass </b></a></li>


													<li class="nav-item "  style="font-size: 15px;"><a href="#vertical-left-tab2" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> <b> Lungs</b></a></li>



													<li class="nav-item "  style="font-size: 15px;"><a href="#vertical-left-tab3" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> <b> Liver</b></a></li>


													<li class="nav-item "  style="font-size: 15px;"><a href="#vertical-left-tab4" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> <b> Heart</b></a></li>


													<li class="nav-item "  style="font-size: 15px;"><a href="#vertical-left-tab5" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> <b> Intestine</b></a></li>


													<li class="nav-item "  style="font-size: 15px;"><a href="#vertical-left-tab6" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> <b> Trimmings</b></a></li>

													<li class="nav-item "  style="font-size: 15px;"><a href="#vertical-left-tab7" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> <b> Feet</b></a></li>

													<li class="nav-item "  style="font-size: 15px;"><a href="#vertical-left-tab8" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> <b> Kidney</b></a></li>


													<li class="nav-item "  style="font-size: 15px;"><a href="#vertical-left-tab9" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> <b> Spleen</b></a></li>




													<a href="by_national_summary_report.php?from=<?php echo $_GET['from'] ?>&to=<?php echo $_GET['to'] ?>" class="btn btn-primary">Back</a>
												</ul>
												<div class="tab-content" style=" width: 100% !important;">
													<div class="tab-pane fade show active" id="vertical-left-tab1">
														 	 	...
														 	 	<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo national_summary_fhc_carcass_posmd() ?>
								                                    </tbody>
								                                </table>
													...
													<div class="tab-pane fade" id="vertical-left-tab2">
																...
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo national_summary_fhc_lungs_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
													<div class="tab-pane fade" id="vertical-left-tab3">
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo national_summary_fhc_liver_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
													...
													<div class="tab-pane fade" id="vertical-left-tab4">
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo national_summary_fhc_heart_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
													...
													<div class="tab-pane fade" id="vertical-left-tab5">
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo national_summary_fhc_intestine_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
													...
													<div class="tab-pane fade" id="vertical-left-tab6">
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo national_summary_fhc_trimmings_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
													...
													<div class="tab-pane fade" id="vertical-left-tab7">
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo national_summary_fhc_feet_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
													...
													<div class="tab-pane fade" id="vertical-left-tab8">
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo national_summary_fhc_kidney_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
													...
													<div class="tab-pane fade" id="vertical-left-tab9">
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo national_summary_fhc_spleen_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
