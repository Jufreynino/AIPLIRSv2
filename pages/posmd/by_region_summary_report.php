							...
							<div class="card-body py-0">
                                <table class="table table-bordered table-striped  datatable-responsive">
                                    ...
                                    <tr class="text-center">
                                            ...
                                            <th colspan="2">Receiving of Live Animals</th>
                                            <th colspan="2">Fit for Slaughter</th>
                                            <th colspan="2">Fit for Human Consumption</th>
                                        </tr>
                                        <tr class="text-center">
                                            <th>Head Count</th>
                                    ...
                                    <tbody>
										...
										<?php echo region_summary_report_posmd() ?>
