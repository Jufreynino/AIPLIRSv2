			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="posms_account.php" class="nav-link active">
								<i class="icon-user"></i>
								<span>
								POSMS Accounts
								</span>
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline" style="background-color:#26a69a; color:white;">
								<h4 class="card-title" style=" font-weight:bold !important;">POSMS Accounts</h4>
									...
									<div class="form-check form-check-right form-check-switchery form-check-switchery-sm">
										<label class="form-check-label">
											...
											<input type="checkbox" class="form-input-switchery" checked data-fouc>
                                              ...
                                              <!-- <button type="button" class="btn bg-primary-800" data-toggle="modal" data-target="#modal_theme_primary">Add POSMS Account </button> -->
							</div>
...
<br>
													<table class="table table-bordered table-striped  datatable-responsive" >
														...
														<thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;">
															<tr>
																<th class="text-center" style=" font-weight:bold !important;">Employee Number</th>
																<th class="text-center" style=" font-weight:bold !important;">Name</th>
																<th class="text-center" style=" font-weight:bold !important;">Email</th>
																<th class="text-center" style=" font-weight:bold !important;">Contact Number</th>
																<th class="text-center" style=" font-weight:bold !important;">Username</th>
																<th class="text-center" style=" font-weight:bold !important;">Region</th>
																<th class="text-center" style=" font-weight:bold !important;">Account Status</th>
																<th class="text-center" style=" font-weight:bold !important;">Action</th>
															</tr>
														</thead>
														<tbody>
															<?php echo posms_accounts()?>
														</tbody>
													</table>
                                        	</div>
                                        </div>
