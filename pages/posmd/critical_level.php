					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item">
									<a href="by_region_fhc.php" class="nav-link">By Region
									</a>
								</li>
								<li class="nav-item">
									<a href="by_province_fhc.php" class="nav-link">By Province
									</a>
								</li>
								<li class="nav-item">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4> <span class="font-weight-semibold"></span> POSMD</h4>
			...
			<div class="content">
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title"><b>Antemortem - Critical Level</b></h5>
                                        ...
                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
                                            <div class="card-statistic-3 p-4">
                                                ...
                                                <table class="table table-bordered" style="margin-top:-25px;">
													...
													<tr>
                                                <?php echo fetch_all_critical_antemortem_suspected() ?>
													</tr>  
                                        ...
                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
                                            <div class="card-statistic-3 p-4">
                                                ...
                                                <table class="table table-bordered" style="margin-top:-25px;">
													...
													<tr>
                                                <?php echo fetch_all_critical_antemortem_rejected() ?>
													</tr>  
                                        ...
                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
                                            <div class="card-statistic-3 p-4">
                                                ...
                                                <table class="table table-bordered" style="margin-top:-25px;">
													...
													<tr>
                                                <?php echo fetch_all_critical_antemortem_condemned() ?>
													</tr>  
                                                </table>
                                            </div>
                                        </div>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="card ">
							<div class="card-header header-elements-inline">
								<h5 class="card-title"><b>Postmortem - Critical Level</b></h5>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                	</div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_critical_postmortem_carcass() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_critical_postmortem_lung() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_critical_postmortem_liver() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_critical_postmortem_heart() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_critical_postmortem_intestine() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_critical_postmortem_feet() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_critical_postmortem_kidneys() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_critical_postmortem_spleen() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
		                                        ...
		                                        <div class="card"  style="border:1px solid #b7b7b7; border-radius: 0;">
		                                            <div class="card-statistic-3 p-4">
		                                                ...
		                                                <table class="table table-bordered" style="margin-top:-25px;">
															...
															<tr>
		                                                <?php echo fetch_all_critical_postmortem_trimmings() ?>
															</tr>  
		                                                </table>
		                                            </div>
		                                        </div>
