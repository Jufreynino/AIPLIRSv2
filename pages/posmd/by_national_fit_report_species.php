												...
												<div class="tab-content" style=" width: 100% !important;">
													<div class="tab-pane fade show active" id="vertical-left-tab1">
														 	 	...
														 	 	<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo national_summary_ffs_suspect_posmd() ?>
								                                    </tbody>
								                                </table>
													...
													<div class="tab-pane fade" id="vertical-left-tab2">
																...
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo national_summary_ffs_reject_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
													<div class="tab-pane fade" id="vertical-left-tab3">
																<table class="table table-bordered table-striped  datatable-responsive" >
								                                    ...
								                                    <tbody>
								                                    	<?php echo national_summary_ffs_condemned_posmd() ?>
								                                    </tbody>
								                                </table>
													</div>
												</div>
