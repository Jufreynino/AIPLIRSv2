					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline" style="background-color:#26a69a; color:white;">
								<h4 class="card-title"  style="font-weight:bold !important;">	Postmortem Condemnation Report</p></h4><br>
												...
												<table class="table datatable-condemned-disease table-bordered table-striped">
													<thead style="background-color:#324147; color:white;">
														<tr class="text-center">
															<th  style="font-weight:bold !important;">Code</th>
															<th  style="font-weight:bold !important;">Disease / Condition</th>
															<th  style="font-weight:bold !important;">Judgement</th>
															<th  style="font-weight:bold !important;">Species</th>
															<th  style="font-weight:bold !important;">Date Range</th>
															...
															<?php if(isset($_POST['search_antemortem_condemnation'])) {?>
																...
																<?php } else if(empty($_POST['city'])) {?>
																	<th  style="font-weight:bold !important;">Region</th>
																	<th  style="font-weight:bold !important;">Province</th>
																<?php } else {?>
																	<th  style="font-weight:bold !important;">Region</th>
																	<th  style="font-weight:bold !important;">Province</th>
																	<th  style="font-weight:bold !important;">City</th>
																<?php } ?>
													...
													<tbody>
														<?php echo disease_report_postmortem_daily() ?>
													</tbody>
												</table>
									</div>
								</div>	
