			...
			<div class="sidebar-content">
				...
				<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item">
									<a href="by_national_fit_report.php" class="nav-link active">National Data
									</a>
								</li>
															...
															<div class="col-md-12">
																...
																<thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;  ">
																	<tr>
																		...
																		<?php if(isset($_POST['search_national_data_fit_for_slaughter'])) { ?>
																				<?php if(empty($_POST['region']) && empty($_POST['province']) && empty($_POST['city'])) {?>
																					<th rowspan="3" class="sticky-col first-col text-center" style="background-color:white !important; color:black; text-align:center; font-weight:bold !important;">Grand Total</th>
																						<th rowspan="3" class="sticky-col first-col" style="width:100px;  background-color:white !important; color:black; text-align:center; font-weight:bold !important;">National Data</th>

																				<?php } else if(empty($_POST['province']) && empty($_POST['city'])){ ?>
																						<th rowspan="3" class="sticky-col first-col text-center" style="background-color:white !important; color:black; text-align:center; font-weight:bold !important;">Grand Total</th>
																						<th rowspan="3" class="sticky-col first-col" style="width:100px;  background-color:white !important; color:black; text-align:center; font-weight:bold !important;">Region</th>

																				<?php } else if(empty($_POST['city'])){ ?>
																					<th rowspan="3" class="sticky-col first-col text-center" style="background-color:white !important; color:black; text-align:center; font-weight:bold !important;">Grand Total</th>
																						<th rowspan="3" class="sticky-col first-col" style="width:100px;  background-color:white !important; color:black;  text-align:center; font-weight:bold !important;">Region</th>
																						<th rowspan="3" class="sticky-col first-col" style="width:100px;  background-color:white !important; color:black;  text-align:center; font-weight:bold !important;">Province</th>
																				<?php } else { ?>
																					<th rowspan="2" class="sticky-col first-col" style="width:150px;  background-color:white !important; color:black;  text-align:center; font-weight:bold !important;">Grand</th>
																				<?php } ?>
																		<?php } ?>


																		<th colspan="2" style="background-color: #3bb8d5; color:white; text-align:center; font-weight:bold !important;">HOG </th>
																			<th  colspan="2" style="background-color: #eb5555fa; color:white; text-align:center; font-weight:bold !important;">CHICKEN</th>
																		<th  colspan="2" style="background-color: #a277f7; color:white; text-align:center; font-weight:bold !important;">CATTLE</th>
																		<th  colspan="2" style="background-color: #77a4f7; color:white; text-align:center; font-weight:bold !important;">CARABAO</th>
																	
																		<th  colspan="2" style="background-color: #7fc998; color:white; text-align:center; font-weight:bold !important;">HORSE</th>
																		<th  colspan="2" style="background-color: #2cb1a4; color:white; text-align:center; font-weight:bold !important;">GOAT</th>
																		<th  colspan="2" style="background-color: #f7a677; color:white; text-align:center; font-weight:bold !important;">SHEEP</th>
																		<th  colspan="2" style="background-color: #4faf44; color:white; text-align:center; font-weight:bold !important;">DUCK</th>
																		<th  colspan="2" style="background-color: #e77393; color:white; text-align:center; font-weight:bold !important;">PIGEON</th>
																		<th  colspan="2" style="background-color: #ba7abb; color:white; text-align:center; font-weight:bold !important;">OSTRICH </th>
																		<th  colspan="2" style="background-color: #f7a677; color:white; text-align:center; font-weight:bold !important;">CROCODILE </th>
																	</tr>
																	<tr>
																	...
																	<?php echo national_slaughter_report_posmd_grandtotal()?>
															</table>
																	...
																	<table class="table table-bordered table-striped" style="">
																		...
																		<thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;  ">
																			<tr>
																				...
																				<?php if(isset($_POST['search_national_data_fit_for_slaughter'])) { ?>
																						<?php if(empty($_POST['region']) && empty($_POST['province']) && empty($_POST['city'])) {?>
																							<th class="sticky-col first-col" rowspan="2" style="width:150px;  background-color:white !important; color:black; text-align:center; font-weight:bold !important;">Region</th>
																				

																						<?php } else if(empty($_POST['province']) && empty($_POST['city'])){ ?>
																							<th class="sticky-col first-col" rowspan="2" style="width:150px;  background-color:white !important; color:black; text-align:center; font-weight:bold !important;">Region</th>
																							<th class="sticky-col second-col" rowspan="2" style="width:150px;  background-color:white !important; color:black; text-align:center; font-weight:bold !important;">Province</th>
																						<?php } else if(empty($_POST['city'])){ ?>
																							<th class="sticky-col first-col" rowspan="2" style="width:150px;  background-color:white !important; color:black; text-align:center; font-weight:bold !important;">Region</th>
																							<th class="sticky-col second-col"  rowspan="2" style="width:150px;  background-color:white !important; color:black; text-align:center; font-weight:bold !important;">Province</th>
																							<th class="sticky-col third-col"  rowspan="2" style="width:150px;  background-color:white !important; color:black; text-align:center; font-weight:bold !important;">Municipality / City</th>
																		...
																		<tbody>
																			<?php echo national_slaughter_report_posmd_regional()?>
																		</tbody>
																	</table>
																</div>
															</div>
											...
											<table class="table table-bordered table-striped  datatable-responsive">
												<thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;">
													<tr class="text-center">
														...
														<th  style=" font-weight:bold !important; ">Total Weight (kg)</th>
														<th   style=" font-weight:bold !important; " class="text-center">Actions</th>
													</tr>
												</thead>
												<tbody>

													<?php echo national_slaughter_report_posmd_search() ?>
