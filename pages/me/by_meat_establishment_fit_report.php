                                    ...
                                    <div class="card " style="border-radius: 0;">
                                        <div class="card-body ">
                                            <div class="text-center">
                                                <h1 style="font-weight:bold;">Fit for Slaughter</h1>
...
<br>
																		<div class="form-group">
																			<label class="col-form-label"></label>
																				<button type="submit" name="search_me_data_fit_for_slaughter_me_mio" class="btn btn-primary" style="margin-top:17px;">Filter</button>
																		</div>
																	</div>
																	</form>
														</div>
																	...
																	<div class="wrapper">
																		<table class="table table-bordered table-striped ">
																			...
																			<tbody>
																				...
																				<?php echo me_slaughter_report_posmd_me() ?>
