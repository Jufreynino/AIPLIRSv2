				...
				<div class="row">
						...
						<form method="POST">
                            ...
                            <div class="card">
								...
								<h4 class="card-title" style="font-weight:bold;">Daily Meat Inspection Report</b></h4>
							...
							<div class="card-body py-0">
								...
								<div class="row">
										...
										<div class="col-md-2">
											<div class="form-group">
												...
												<br>
														<button type="submit" class="btn btn-primary" name="btn_filter_dmir" style="margin-top:7px;">Filter</button>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<table style="width: 100%; margin-top:20px;" class="table table-stripped table-bordered">
										<tr style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;">
											...
											<th class="text-center" style="font-weight:bold;">Meat Establishment</th>
											<th class="text-center" style="font-weight:bold;">Type</th>
											<th class="text-center" style="font-weight:bold;">Classification</th>
											<th class="text-center" style="font-weight:bold;">LTO Number</th>
											<th class="text-center" style="font-weight:bold;">LTO Expiration Date</th>
