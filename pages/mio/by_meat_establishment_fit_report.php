                                    ...
                                    <div class="card " style="border-radius: 0;">
                                        <div class="card-body ">
                                            <div class="text-center">
                                                <h1><b>Fit for Slaughter</b></h1>
                                                <?php if(isset($_POST['search_me_data_fit_for_slaughter_me_mio'])) { ?>
																	...
																	<div class="col-md-3">
																		<div class="form-group">
																			...
																			<label class="col-form-label text-right"></label>
																				<button type="submit" name="search_me_data_fit_for_slaughter_me_mio" class="btn btn-primary" style="margin-top:15px;">Filter</button>
																		</div>
																	</div>
																	</form>
														</div>
									...
									<table class="table table-bordered table-striped ">
										<thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;">
											<tr class="text-center">
												<th style=" font-weight:bold; background-color:white !important; color:black;" rowspan="2" class="sticky-col first-col" style=" font-weight:bold; background-color:white !important; color:black;">Meat Establishment</th>
										...
										<tbody>
											...
											<?php echo me_slaughter_report_posmd_mio() ?>
