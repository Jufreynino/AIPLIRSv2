                                    ...
                                    <div class="card " style="border-radius: 0;">
                                        <div class="card-body ">
                                            <div class="text-center">
                                                <h1><b>Postmortem Condemnation Report</b></h1>
																	...
																	<div class="col-md-3">
																		<div class="form-group">
																			...
																			<label class="col-form-label text-right"></label>
																				<button type="submit" name="disease_antemortem_filter" class="btn btn-primary" style="margin-top:15px;">Filter</button>
																		</div>
																	</div>
																	</form>
														</div>
                                ...
                                <table class="table datatable-basic table-bordered" >
													<thead style="background-color:#324147; color:white;">
														<tr class="text-center">
															...
															<?php if(isset($_POST['disease_antemortem_filter'])){ ?>
																<?php if(!empty($_POST['meat_establishments'])) { ?>
																	<th style="font-weight:bold;">Meat Establishment</th>

																	<?php } else { } ?>
																	
															<?php } ?>
															<th style="font-weight:bold;">Disease / Condition</th>
															<th style="font-weight:bold;">Judgement</th>
															<th style="font-weight:bold;">Species</th>
															<th style="font-weight:bold;">Date Range</th>
															<th style="font-weight:bold;">Total Head Count</th>
															<th style="font-weight:bold;">Total Dressed Weight (kg)</th>
														</tr>
													</thead>
													<tbody>
														<?php echo disease_report_postmortem_daily_mio() ?>
													</tbody>
												</table>
                                                <br>
                                                <br>
