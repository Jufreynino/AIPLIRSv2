			...
			<div class="content">
				<div class="row">
										...
										<?php echo show_plant_profile() ?>
														<div class="card">
															<div class="card-header  header-elements-inline" style="background-color:#26a69a; color:white;">
																<span class="card-title font-weight-semibold"  style="font-weight:bold;">C. Summary of Food Animals Passed for Slaughter</span>
																...
																<div class="nav nav-sidebar my-2">
																	...
																	<li class="nav-item">
																		<a  class="nav-link" style="color:black;">
																			Head Count
																			<span class="font-size-sm font-weight-normal ml-auto"><?php echo modify_antemortem_sum_total_heads(); ?></span>
																		</a>
																	</li>
																	<li class="nav-item">
																		<a href="#" class="nav-link" style="color:black;">
																			 Total Live Weight (kg)
																			<span class="font-size-sm font-weight-normal ml-auto"><?php echo modify_antemortem_sum_total_weight() ?></span>
																		</a>
																	</li>
																</div>
														...
														<button type="submit" name="btn_save_fhc" class="btn bg-purple btn-block btn-lg">Proceed to Postmortem Inspection</button>
                                                        	

                                                        <a href="am_pm_list.php?md=<?php echo $_GET['med'] ?>&mdate=<?php echo $_GET['mdate']?>&species=<?php echo $_GET['species']?>&category=<?php echo $_GET['category']?>&region=<?php echo $_GET['region']?>&province=<?php echo $_GET['province']?>&city=<?php echo $_GET['city']?>&barangay=<?php echo $_GET['barangay']?>" class="btn btn-warning btn-block">Back</a>
																<?php echo udpate_fhc_daily() ?>
							</div>
						...
						<div class="col-md-8" >
								...
								<div class="card">
										<div class="card-header header-elements-inline" style="background-color:#26a69a; color:white;">
											<span class="card-title font-weight-semibold"  style="font-weight:bold;">B. Conduct of Antemortem Inspection</span>
											<div class="header-elements">
												<div class="list-icons">
													<a class="list-icons-item" data-action="collapse"></a>
												</div>
											...
											<h4>Suspect / On hold</h4>
												<table style="width: 100%; margin-top:20px;" class="table table-bordered" >
													<tr style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; ">
														...
														<th style="font-size:12px !important; font-weight:bold;">Rejected / Condemned</th>
														<th style="font-size:12px !important; font-weight:bold;">Passed for slaughter</th>
														<th style="font-size:12px !important; font-weight:bold;">Action</th>
														<th style="font-size:12px !important; font-weight:bold;">Status</th>
													</tr>
												...
												<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add_suspect">Add Suspect / On hold for Slaughter</button>

												<div id="add_suspect" class="modal fade"  data-backdrop="static" >
														...
														<div class="modal-content">
															...
															<form method="POST">
																...
																<div class="form-group row">
																	...
																	<div class="col-sm-7">
																<input type="number" placeholder="0" name="heads" id="suspected_number_of_heads" class="form-control suspect_number" required>
																		<div id="errors_noheads"></div>																		
																...
																<div class="form-group row">
																	...
																	<div class="col-sm-7">
																	<input type="text" placeholder="0" name="weight" id="suspected_number_of_weight" class="form-control suspect_number" required>
																		<div id="errors_noweight"></div>																		
																...
																<div class="form-group row">
																	...
																	<div class="col-sm-8">
																		<?php echo fetch_antemortem_disease_suspect() ?>
																	</div>
																</div>
															...
															<div class="modal-footer">
																<button type="submit" name="btn_submit" class="btn bg-primary s_antemortem_button ">Add Suspect / On hold</button>
											...
											<h4>Rejected for Slaughter</h4>
												<table style="width: 100%; margin-top:20px;" class="table  table-bordered" >
													<tr style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; ">
														...
														<th style="font-size:12px !important; font-weight:bold;">Total Live Weight (kg)</th>
														<th style="font-size:12px !important; font-weight:bold;">Action</th>
														<th style="font-size:12px !important; font-weight:bold;">Remarks</th>
													</tr>
