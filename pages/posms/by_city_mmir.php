					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu  nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item">
									<a href="by_city_mmir.php" class="nav-link active">By City 
									</a>
								</li>
								<li class="nav-item">
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline" style="background-color:#324147; color:white;">
									<h4 class="card-title">Municipality / City<p style="font-size:15px;">Meat Inspection Report </p> <p><?php echo $_SESSION['region'] ?></p></h4>
								</div>
								<br>
								<br>
							...
							<div class="card-body py-0">
								<div class="row">
									...
									<div class="col-md-6">
										<form method="GET" action="by_city_mmir_report.php">
