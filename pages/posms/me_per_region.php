...
if(isset($_SESSION['employee_id']))
{
    ...
    header('location: ../../pages/auth/index.php');
           ...
           reject_meat_establishment_application();
           assign_mio()
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="me_per_region.php" class="nav-link active">
			...
			<div class="content">
				<div class="row">
					...
					<div class="card-header header-elements-inline" style="background-color:#26a69a; color:white;">
						<h4 class="card-title" style="font-weight:bold;">Meat Establishment Accounts</h4>
					</div>
						<br>
							<br>
						<div class="card">
									...
									<table class="table table-bordered table-striped  datatable-responsive">
										<thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;">
											<tr class="text-center">
												...
												<th style="font-weight:bold !important;">Establishment Owner</th>
												<th style="font-weight:bold !important;">Type</th>
												<th style="font-weight:bold !important;">Classification</th>
												...
												<th style="font-weight:bold !important;">Address</th>
												<th style="font-weight:bold !important;">Account Status</th>
												<th style="font-weight:bold !important;">List of MIO Assigned</th>
												<th style="font-weight:bold !important;">Action</th>
											</tr>
										</thead>
										<tbody>
											<?php echo me_per_reg_posms()?>
