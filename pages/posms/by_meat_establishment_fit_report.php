...
<head>
	...
	<script src="../../global_assets/js/demo_pages/dashboard.js">
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu  nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item">
									<a href="by_meat_establishment_fit_report.php" class="nav-link  active">Meat Establishment Data
									</a>
								</li>
...
<br><br>
							   ...
							   <table class="table table-bordered datatable-responsive table-striped ">
									...
									<tbody>
										...
										<?php echo me_slaughter_report_posms_summ() ?>
