					...
					<div class="col-xl-12">
						<div class="card card-collapsed">
							<div class="card-header header-elements-inline"   style="background-color:#263238; color:white;">
								<h3 class="card-title"> Meat Establishments from the Province of <?php echo $_GET['province'] ?><p style="font-size:15px; ">In the period of <?php echo date('F d, Y', strtotime($_GET['from'])); ?> to <?php echo date('F d, Y', strtotime($_GET['to'])); ?></p><?php echo $_SESSION['region'] ?></h3>
									...
									<div class="col-md-12">
										<div class="wrapper">
										 <table class="table table-bordered table-striped" style="">
                                                ...
                                                <tbody>
                                                    <?php echo mmir_posms_province_me()?>
                                                </tbody>
                                            </table>
									</div>
									</div>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="card card-collapsed"   style="background-color:#263238;">
								...
								<h3 class="card-title">Meat Inspection Report Summary from the Province of <?php echo $_GET['province'] ?><p style="font-size:15px; ">In the period of <?php echo date('F d, Y', strtotime($_GET['from'])); ?> to <?php echo date('F d, Y', strtotime($_GET['to'])); ?></p><p><?php echo $_SESSION['region'] ?></p></h3>
									<div class="header-elements">
										<div class="list-icons">
					                		<a class="list-icons-item" data-action="collapse"></a>
					                	</div>
										...
										<div class="col-md-12">
											<div class="wrapper">
											 <table class="table table-bordered table-striped" style="">
	                                                ...
	                                                <thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;  ">
	                                                    <tr>
	                                                        <th class="sticky-col first-col" style="width:150px;  background-color:#1d2328 !important; color:White;">Province</th>
	                                                          <th style="background-color: #a277f7; color:white;">CATTLE <br><p style="font-size:10px; text-align:center;">Heads</p></th>
                                                        <th style="background-color: #a277f7; color:white;">BEEF <br><p style="font-size:10px; text-align:center;">Weight</p></th>
                                                        <th style="background-color: #77a4f7; color:white;">CARABAO <br><p style="font-size:10px; text-align:center;">Heads</p></th>
                                                        <th style="background-color: #77a4f7; color:white;">CARABEEF <br><p style="font-size:10px; text-align:center;">Weight</p></th>
