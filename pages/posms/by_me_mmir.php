					...
					<div class="col-xl-12">
						<div class="card">
											<div class="card-header header-elements-inline" style="background-color:#324147; color:white;">
																		<h4 class="card-title">Meat Establishments<p style="font-size:15px;">Meat Inspection Report </p> <p><?php echo $_SESSION['region'] ?></p></h4>
																	</div>
									<br>
									<br>
							...
							<div class="card-body py-0">
								<div class="row">
									...
									<div class="col-md-6">
										<form method="GET" action="by_me_mmir_report.php">
											...
											<div class="form-group row">
					                        	<label class="col-form-label col-lg-4 text-right">Meat Establishment</label>
					                        	<div class="col-lg-8">
