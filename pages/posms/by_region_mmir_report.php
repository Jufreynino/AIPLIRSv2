				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							<a href="#" class="nav-link"><i class="icon-file-text3"></i> <span>Meat Inspection Report </span>
							</a>
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item">
									<a href="by_region_mmir.php" class="nav-link active">By Region
										<!-- <span class="badge bg-danger align-self-center ml-auto">2</span> -->
									</a>
								</li>
							</ul>
					...
					<div class="col-xl-12">
						<div class="card card-collapsed">
							<div class="card-header header-elements-inline"   style="background-color:#263238; color:white;">
								<h3 class="card-title"> Meat Establishments from the Region of <?php echo $_SESSION['region'] ?><p style="font-size:15px; ">In the period of <?php echo date('F d, Y', strtotime($_GET['from'])); ?> to <?php echo date('F d, Y', strtotime($_GET['to'])); ?></h3>
				...
				<div class="row">
					<div class="col-xl-12">
						<div class="card card-collapsed"   style="background-color:#263238;">
							...
							<div class="card-header header-elements-inline"   style="background-color:#263238; color:white;">
									<h3 class="card-title">Meat Inspection Report Summary from the Region of <?php echo $_SESSION['region'] ?><p style="font-size:15px; ">In the period of <?php echo date('F d, Y', strtotime($_GET['from'])); ?> to <?php echo date('F d, Y', strtotime($_GET['to'])); ?></p></h3>
										...
										<div class="col-md-12">
											<div class="wrapper">
											 <table class="table table-bordered table-striped" style="">
	                                                ...
	                                                <thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;  ">
	                                                    <tr>
	                                                        <th class="sticky-col first-col" style="width:150px;  background-color:#1d2328 !important; color:White;">Region</th>
	                                                        <th style="background-color: #a277f7; color:white;">CATTLE <br><p style="font-size:10px; text-align:center;">Heads</p></th>
	                                                        <th style="background-color: #a277f7; color:white;">BEEF <br><p style="font-size:10px; text-align:center;">Weight</p></th>
	                                                        <th style="background-color: #77a4f7; color:white;">CARABAO <br><p style="font-size:10px; text-align:center;">Heads</p></th>
	                                                        <th style="background-color: #77a4f7; color:white;">CARABEEF <br><p style="font-size:10px; text-align:center;">Weight</p></th>
