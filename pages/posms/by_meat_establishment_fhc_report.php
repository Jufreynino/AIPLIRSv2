												...
												<form method="POST">
													<div class="col-md-12">
														<div class="row">
																	...
																	<div class="col-md-3">
																		<br><br>
																				<button type="submit" name="search_me_data_fit_for_slaughter" class="btn btn-primary" style="margin-top:-5px;">Filter</button>
																	</div>
																</form>
														</div>
													</div>
									...
									<table class="table table-bordered table-striped ">
											<thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;">
												<tr class="text-center">
													...
													<th colspan="2" style="background-color: #3bb8d5; color:white;">HOG </th>
													<th  colspan="2" style="background-color: #eb5555fa; color:white;">CHICKEN</th>
													<th  colspan="2" style="background-color: #a277f7; color:white;">CATTLE</th>
													<th  colspan="2" style="background-color: #77a4f7; color:white;">CARABAO</th>
												
													<th  colspan="2" style="background-color: #7fc998; color:white;">HORSE</th>
													<th  colspan="2" style="background-color: #2cb1a4; color:white;">GOAT</th>
													<th  colspan="2" style="background-color: #f7a677; color:white;">SHEEP</th>
													<th  colspan="2" style="background-color: #4faf44; color:white;">DUCK</th>
													<th  colspan="2" style="background-color: #e77393; color:white;">PIGEON</th>
													<th  colspan="2" style="background-color: #ba7abb; color:white;">OSTRICH </th>
													<th  colspan="2" style="background-color: #f7a677; color:white;">CROCODILE </th>
												</tr>
												<tr>
											...
											<tbody>
												...
												<?php echo me_fit_report_posms_summ() ?>
