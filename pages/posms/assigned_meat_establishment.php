			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="meat_inspector_account.php" class="nav-link active">
								<i class="icon-user"></i>
								<span>
...
<li class="nav-item-header text-center" style="background-color:#833737;"><div class="text-uppercase font-size-xs line-height-xs " style="font-size: 15px; color:white;">Meat Inspection Report</div> <i class="icon-menu" title="Data visualization"></i></li>
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-file-text3"></i> <span>Summary Meat Inspection</span>
							</a>
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								
								<li class="nav-item">
									<a href="by_region_summary.php" class="nav-link">By Region
									</a>
								</li>
								<li class="nav-item">
									<a href="by_province_summary.php" class="nav-link">By Province
									</a>
								</li>
								<li class="nav-item">
									<a href="by_city_summary.php" class="nav-link">By City 
									</a>
								</li>
								<li class="nav-item">
									<a href="by_meat_establishment_summary.php" class="nav-link">By Meat Establishment
									</a>
								</li>
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-file-text3icon-file-text3"></i> <span>Summary</span>
							</a>
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item">
									<a href="by_regional_mmir.php" class="nav-link">Regional Data
									</a>
								</li>
		...
		<div class="content-wrapper">
			...
			<div class="content">
					...
					<div class="accordion-sortable" id="accordion-controls">
							<div class="card">
								<div class="card-header text-white header-elements-inline" style="background-color:#26a69a;">
									<h6 class="card-title">
										<a data-toggle="collapse" class="text-white collapsed" href="#accordion-controls-group1"><b> Current Meat Estabishment Assignments</b></a>
									</h6>
							...
							<div class="card">
								<div class="card-header text-white  header-elements-inline" style="background-color:#26a69a;">
									<h6 class="card-title">
										<a class="text-white collapsed" data-toggle="collapse" href="#accordion-controls-group2"><b>Previous Meat Estabishment Assignments</b></a>
									</h6>
				...
				<div class="card">
							<div class="card-header text-white header-elements-inline" style="background-color:#26a69a;">
								<h6 class="card-title"><b>Conducted Meat Inspections</b></h6>
								<div class="header-elements">
									<div class="list-icons">
				                	</div>
			                	</div>
							...
							<div class="card-body">
								...
								<ul class="nav nav-tabs nav-tabs-bottom">
									<li class="nav-item"><a href="#bottom-tab1" class="nav-link active" data-toggle="tab">Antemortem Inspection</a></li>
									<li class="nav-item"><a href="#bottom-tab2" class="nav-link" data-toggle="tab">Postmortem Inpection</a></li>
												...
												<div class="card-body">
													<div class="d-md-flex">
														<ul class="nav nav-tabs nav-tabs-vertical flex-column mr-md-3 wmin-md-200 mb-md-0 border-bottom-0">
															<li class="nav-item"><a href="#vertical-left-tab1" class="nav-link active" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Suspect / On hold</a></li>
															<li class="nav-item"><a href="#vertical-left-tab2" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Rejected</a></li>
															<li class="nav-item"><a href="#vertical-left-tab3" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Condemned</a></li>
									...
									<div class="tab-pane fade" id="bottom-tab2">
										<div class="card">
												...
												<div class="card-body">
													<div class="d-md-flex">
														<ul class="nav nav-tabs nav-tabs-vertical flex-column mr-md-3 wmin-md-200 mb-md-0 border-bottom-0">
															<li class="nav-item"><a href="#vertical-left-tab4" class="nav-link active" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Carcass</a></li>
															<li class="nav-item"><a href="#vertical-left-tab5" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Lungs</a></li>
															<li class="nav-item"><a href="#vertical-left-tab6" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Liver</a></li>
															<li class="nav-item"><a href="#vertical-left-tab7" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Heart</a></li>
															<li class="nav-item"><a href="#vertical-left-tab8" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Intestine</a></li>
															<li class="nav-item"><a href="#vertical-left-tab8" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Trimmings</a></li>
															<li class="nav-item"><a href="#vertical-left-tab9" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Feet</a></li>
															<li class="nav-item"><a href="#vertical-left-tab10" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Kidney</a></li>
															<li class="nav-item"><a href="#vertical-left-tab11" class="nav-link" data-toggle="tab"><i class="icon-menu7 mr-2"></i> Spleen</a></li>
