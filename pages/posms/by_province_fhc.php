					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item">
									<a href="by_meat_establishment_receiving.php" class="nav-link">By Meat Establishment
									</a>
								</li>
							</ul>
						</li>
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline" style="background-color:#324147; color:white;">
									<h4 class="card-title">Province<p style="font-size:15px;">Fit for Human Consumption</p></h4>
								</div>
								<br>
							<div class="card-body py-0">
								<div class="row">
									...
									<div class="col-md-6">
										<form method="GET" action="by_province_fhc_report.php">
