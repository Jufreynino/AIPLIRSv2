									...
									<div class="card" style="border:1px solid black; border-radius: 0;">
										...
										<h4 class="card-title text-center"  style="font-weight:bold;">Total Number of Animals Received<p style="font-size:15px;"> January 1 -  <?php echo date('F d') ?>, <?php echo date('Y') ?></p></h4>
											...
											<table class="table table-bordered">
												...
												<?php echo regional_total_received() ?>
											</table>	
									</div>
								</div>
									...
									<div class="card" style="border:1px solid black; border-radius: 0;">
										...
										<h4 class="card-title text-center"  style="font-weight:bold;">Total Number of Animals Slaughtered<p style="font-size:15px;"> January 1 -  <?php echo date('F d') ?>, <?php echo date('Y') ?></p></h4>
											...
											<table class="table table-bordered">
												...
												<?php echo regional_total_slaughtered() ?>
										...
										<h4 class="card-title text-center">Total Volume of Meat Fit For Human Consumption<p style="font-size:15px;"> January 1 -  <?php echo date('F d') ?>, <?php echo date('Y') ?></p></h4>
											...
											<table class="table table-bordered">
												<tr>
													<th  style="font-weight:bold;">Species</th>
													<th  style="font-weight:bold;">Total Head Count</th>
													<th  style="font-weight:bold;">Total Dressed Weight (kg)</th>
												</tr>
												<?php echo regional_total_fhc() ?>
                                                ...
                                                <div class="row ">
	                                            	<div class="col-md-6">
	                                            		<p style="font-size: 15px;">Heads</p>
	                                               			 <p style="font-size: 15px;"><?php echo count_daily_slaughthered_heads_region() ?></p>
	                                            	</div>
	                                            	<div class="col-md-6">
	                                            		<p style="font-size: 15px;">Weight</p>
	                                               			 <p style="font-size: 15px;"><?php echo count_daily_slaughthered_weight_region() ?></p>
	                                            	</div>
                                                </div>
                                                ...
                                                <div class="row ">
	                                            	<div class="col-md-12 text-center">
	                                            		<p style="font-size: 15px;">All Regions</p>
	                                               			 <p style="font-size: 15px;"><?php echo count_accredited_meat_establishment_region() ?></p>
	                                            	</div>
                                                </div>
                                            ...
                                            <div class="card-statistic-3 p-4">
                                                <div class="card-icon card-icon-large"><i class="fas fa-ticket-alt"></i></div>
	                                                <div class="row ">
		                                            	<div class="col-md-12 text-center">
		                                            		<p style="font-size: 15px;">All Regions</p>
		                                               			 <p style="font-size: 15px;"><?php echo count_meat_inspection_officer_region() ?></p>
		                                            	</div>
	                                                </div>
