					...
					<div class="col-xl-12">
						<div class="card">
								<div class="card-header header-elements-inline" style="background-color:#324147; color:white;">
									<h4 class="card-title"><?php echo $_SESSION['region'] ?><p style="font-size:15px;">Meat Inspection Report </p><p><?php echo $_SESSION['region'] ?></p></h4>
								</div>
								<br>
							...
							<div class="card-body py-0">
								<div class="row">
									...
									<div class="col-md-6">
										<form method="GET" action="by_region_mmir_report.php">
