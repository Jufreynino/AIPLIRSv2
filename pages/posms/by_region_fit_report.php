					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu  nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item">
									<a href="by_region_fit_report.php" class="nav-link  active">Regional Data
									</a>
								</li>
															...
															<div class="col-md-12">
																...
																<table class="table table-bordered table-striped" style="">
																		...
																		<thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;  ">
																			...
																			<tr>
																				<th  style="background-color: #3bb8d5; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Heads</p></th>
																				<th style="background-color: #3bb8d5; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Weight (kg)</p></th>
																					<th style="background-color: #eb5555fa; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Heads</p></th>
																				<th style="background-color: #eb5555fa; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Weight (kg)</p></th>
																				<th style="background-color: #a277f7; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Heads</p></th>
																				<th style="background-color: #a277f7; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Weight (kg)</p></th>
																				<th style="background-color: #77a4f7; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Heads</p></th>
																				<th style="background-color: #77a4f7; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Weight (kg)</p></th>
																			
																				<th style="background-color: #7fc998; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Heads</p></th>
																				<th style="background-color: #7fc998; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Weight (kg)</p></th>
																				<th style="background-color: #2cb1a4; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Heads</p></th>
																				<th style="background-color: #2cb1a4; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Weight (kg)</p></th>
																				<th style="background-color: #f7a677; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Heads</p></th>
																				<th style="background-color: #f7a677; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Weight (kg)</p></th>

																				<th style="background-color: #4faf44; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Heads</p></th>
																				<th style="background-color: #4faf44; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Weight (kg)</p></th>




																				<th style="background-color: #e77393; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Heads</p></th>
																				<th style="background-color: #e77393; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Weight (kg)</p></th>


																				<th style="background-color: #ba7abb; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Heads</p></th>
																				<th style="background-color: #ba7abb; color:white;"><p style="font-size:14px; text-align:center; font-weight:bold;">Weight (kg)</p></th>
																			...
																			<?php echo national_slaughter_report_posms_grandtotal()?>
																	</table>
																	...
																	<table class="table table-bordered table-striped" style="">
																		...
																		<tbody>
																			<?php echo national_slaughter_report_posms_regional()?>
																		</tbody>
																	</table>
																</div>
															</div>
										...
										<div class="tab-pane fade" id="highlighted-justified-tab4">
											<table class="table table-bordered table-striped  datatable-responsive">
												...
												<tbody>
													...
													<?php echo national_slaughter_report_posms_search() ?>
