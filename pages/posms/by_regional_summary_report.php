					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline" style="background-color:#324147; color: #ffffff;">
								<h4 class="card-title">CONSOLIDATED MONTHLY SLAUGHTER  <p style=" font-size:15px;">as of <?php echo date('F d, Y',strtotime(str_replace('-','/',$_GET['from'])))   ?> - <?php echo date('F d, Y',strtotime(str_replace('-','/',$_GET['to'])))   ?> </p></h4>
							</div>
                    <br>
											...
											<div class="wrapper">
											 <table class="table table-bordered table-striped" style="">
	                                                ...
	                                                <thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;  ">
                                                        ...
                                                        <th style="background-color: #7fc998; color:white;">HORSE MEAT <br><p style="font-size:10px; text-align:center;">Weight</p></th>
                                                        ...
                                                        <th style="background-color: #4faf44; color:white;">Dressed Duck <br><p style="font-size:10px; text-align:center;">Weight</p></th>




                                                        <th style="background-color: #e77393; color:white;">PIGEON <br><p style="font-size:10px; text-align:center;">Heads</p></th>
                                                        <th style="background-color: #e77393; color:white;">DRESSED PIGEON <br><p style="font-size:10px; text-align:center;">Weight</p></th>


                                                        <th style="background-color: #ba7abb; color:white;">OSTRICH <br><p style="font-size:10px; text-align:center;">Heads</p></th>
                                                        <th style="background-color: #ba7abb; color:white;">DRESSED OSTRICH <br><p style="font-size:10px; text-align:center;">Weight</p></th>


                                                        <th style="background-color: #f7a677; color:white;">CROCODILE <br><p style="font-size:10px; text-align:center;">Heads</p></th>
                                                        <th style="background-color: #f7a677; color:white;">CROCODILE MEAT <br><p style="font-size:10px; text-align:center;">Weight</p></th>


	                                                    </tr>
	                                                </thead>
	                                                <tbody>
	                                                    <?php echo mmir_posms_region_summary()?>
	                                                </tbody>
	                                            </table>
										    </div>
									    </div>
            ...
            <div class="content">
				<div class="row">
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline" style="background-color:#324147; color: #ffffff;">
								<h4 class="card-title">Provincial MONTHLY SLAUGHTER  <p style=" font-size:15px;">as of <?php echo date('F d, Y',strtotime(str_replace('-','/',$_GET['from'])))   ?> - <?php echo date('F d, Y',strtotime(str_replace('-','/',$_GET['to'])))   ?> </p></h4>
							</div>
                    <br>
							<div class="card-body py-0">
                            <div class="row">
										<div class="col-md-12">
											<div class="wrapper">
											 <table class="table table-bordered table-striped" style="">
	                                                ...
	                                                <thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; color:white;  ">
	                                                    <tr>
	                                                        <th class="sticky-col first-col" style="width:150px;  background-color:white !important; color:black;">Province</th>
	                                                        <th style="background-color: #3bb8d5; color:white;">HOG <br><p style="font-size:10px; text-align:center;">Heads</p></th>
                                                        <th style="background-color: #3bb8d5; color:white;">PORK <br><p style="font-size:10px; text-align:center;">Weight</p></th>
                                                             <th style="background-color: #eb5555fa; color:white;">CHICKEN <br><p style="font-size:10px; text-align:center;">Heads</p></th>
                                                        <th style="background-color: #eb5555fa; color:white;">DRESSED CHICKEN <br><p style="font-size:10px; text-align:center;">Weight</p></th>
	                                                ...
	                                                <tbody>
	                                                    <?php echo mmir_posms_province_summary()?>
	                                                </tbody>
	                                            </table>
										    </div>
									    </div>
