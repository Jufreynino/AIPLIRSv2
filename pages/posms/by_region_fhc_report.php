					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item">
									<a href="by_region_fhc_report.php" class="nav-link  active">Regional Data
									</a>
								</li>
						...
						<div class="card   border-top-2 border-top-slate border-bottom-2 border-bottom-slate rounded-0" style="border-radius: 0;">
							<div class="card-body ">
										<div class="text-center">
											...
											<p style="font-size:15px; "><?php if(isset($_POST['search_national_data_fit_for_slaughter'])) { ?>For the period of <?php echo date('F d, Y', strtotime($_POST['from'])); ?> to <?php echo date('F d, Y', strtotime($_POST['to'])); }?></p>
										</div>
							</div>
						</div>
					</div>
												...
												<div class="col-md-12">
													<div class="col-md-12">
														<div class="row">
																	...
																	<div class="col-md-3">
																		<br><br>
																				<button type="submit" name="search_national_data_fit_for_slaughter" style="margin-top:-5px;" class="btn btn-primary">Filter</button>
																	</div>
														</div>
													</div>
												</div>
														...
														<div class="row">
															<div class="col-md-12">
																...
																<table class="table table-bordered table-striped" style="">
																		...
																		<thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #bdb8b8; background-color:#1d2328; ">
																			...
																			<?php if(isset($_POST['search_national_data_fit_for_slaughter'])) { ?>
																					<?php if(empty($_POST['province']) && empty($_POST['city'])) {?>
																						...
																						<th rowspan="1" class="sticky-col first-col" style="width:100px;  background-color:white !important; color:black;  text-align:center !important; font-weight:bold !important;">Region</th>
																						<th rowspan="1" class="sticky-col first-col" style="width:100px;  background-color:white !important; color:black;  text-align:center !important; font-weight:bold !important;">Province</th>
																			...
																			<?php } ?>
																				...
																				<th style="background-color: #3bb8d5; color:white; "><b>HOG </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Heads</p></th>
																				<th style="background-color: #3bb8d5; color:white; "><b>PORK </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Weight (kg)</p></th>
																					<th style="background-color: #eb5555fa; color:white; "><b>CHICKEN </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Heads</p></th>
																				<th style="background-color: #eb5555fa; color:white; "><b>DRESSED CHICKEN</b>  <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Weight (kg)</p></th>
																				<th style="background-color: #a277f7; color:white; "><b>CATTLE </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Heads</p></th>
																				<th style="background-color: #a277f7; color:white; "><b>BEEF </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Weight (kg)</p></th>
																				<th style="background-color: #77a4f7; color:white; "><b>CARABAO </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Heads</p></th>
																				<th style="background-color: #77a4f7; color:white; "><b>CARABEEF </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Weight (kg)</p></th>
																			
																				<th style="background-color: #7fc998; color:white; "><b>HORSE </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Heads</p></th>
																				<th style="background-color: #7fc998; color:white; "><b>HORSE MEAT</b>  <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Weight (kg)</p></th>
																				<th style="background-color: #2cb1a4; color:white; "><b>GOAT </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Heads</p></th>
																				<th style="background-color: #2cb1a4; color:white; "><b>CHEVON </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Weight (kg)</p></th>
																				<th style="background-color: #f7a677; color:white; "><b>SHEEP </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Heads</p></th>
																				<th style="background-color: #f7a677; color:white; "><b>MUTTON </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Weight (kg)</p></th>

																				<th style="background-color: #4faf44; color:white; "><b>DUCK </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Heads</p></th>
																				<th style="background-color: #4faf44; color:white; "><b>DRESSED DUCK</b>  <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Weight (kg)</p></th>




																				<th style="background-color: #e77393; color:white; "><b>PIGEON </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Heads</p></th>
																				<th style="background-color: #e77393; color:white; "><b>DRESSED PIGEON </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Weight (kg)</p></th>


																				<th style="background-color: #ba7abb; color:white; "><b>OSTRICH </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Heads</p></th>
																				<th style="background-color: #ba7abb; color:white; "><b>DRESSED OSTRICH</b>  <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Weight (kg)</p></th>


																				<th style="background-color: #f7a677; color:white; "><b>CROCODILE </b> <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Heads</p></th>
																				<th style="background-color: #f7a677; color:white; "><b>CROCODILE MEAT</b>  <br><p style="font-size:14px; text-align:center; font-weight:bold !important;">Weight (kg)</p></th>


																			</tr>
																			<?php echo national_fhc_report_posms_grandtotal()?>
																	</table>
																	...
																	<table class="table table-bordered table-striped" style="">
																		...
																		<tbody>
																			<?php echo national_fhc_report_posms_regional()?>
																		</tbody>
																	</table>
																</div>
															</div>
										...
										<div class="tab-pane fade" id="highlighted-justified-tab4">
											<table class="table table-bordered table-striped  datatable-responsive">
												...
												<tbody>
													...
													<?php echo national_fit_report_posms_search() ?>
