				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu  nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item">
									<a href="disease_antemortem_report.php" class="nav-link active">Antemortem
									</a>
								</li>
								<li class="nav-item">
				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card-header header-elements-inline" style="background-color:#26a69a; color:white;">
							<h4 class="card-title">Antemortem Condemnation Report</h4><br>
							</div>
							<br>
							<form method="POST" >
							...
							<div class="card-body py-0">				
								<div class="row"> 
									<div class="col-md-12">
									<table class="table datatable-condemned-disease  table-bordered" >
													<thead style="background-color:#324147; color:white;">
														<tr class="text-center">
															...
															<th><b>Total Live Weight (kg)</b></th>
													...
													<tbody>
														<?php echo disease_report_antmortem_daily_posms() ?>
													</tbody>
												</table>
									</div>
								</div>	
