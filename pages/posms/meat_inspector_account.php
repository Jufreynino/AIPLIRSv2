				...
				<div class="row">
					<div class="col-xl-12">
						<div class="card">
							...
							<h4 class="card-title"  style="font-weight:bold;">Meat Inspection Officer Account</h4>
                                    ...
                                    <div class="row">
										<div class="wrapper">
                                            <table class="table table-bordered table-striped  datatable-responsive" >
                                                ...
                                                <thead style="padding:10px !important; height:20px !important; margin:20px !important; border:1px solid #26a69a; background-color:#1d2328; color:white;">
                                                    <tr class="text-center">
                                                        <th style="font-weight:bold;">Employee Number</th>
