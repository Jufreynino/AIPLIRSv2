...
<head>
	...
	<script src="../../global_assets/js/demo_pages/datatable_condemnation_disease.js"></script>
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu  nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item">
									<a href="disease_postmortem_report.php" class="nav-link active">Postmortem
									</a>
								</li>
							</ul>
						</li>
					...
					<div class="col-xl-12">
						<div class="card">
							<div class="card-header header-elements-inline" style="background-color:#26a69a; color:white;">
								<h4 class="card-title">	Postmortem Condemnation Report</p></h4><br>
														...
														<div class="col-md-3">
															<div class="form-group"><br><br>
																<label class="col-form-label text-right"></label>
																	<button type="submit" name="search_antemortem_condemnation" style="margin-top:-5px;" class="btn btn-primary">Filter</button>
															</div>
														</div>
							...
							<div class="card-body py-0">				
								<div class="row"> 
									<div class="col-md-12">
									<table class="table datatable-condemned-disease table-bordered table-striped" >
													<thead style="background-color:#324147; color:white;">
														<tr class="text-center">
															<th><b>Code</b></th>
															<th><b>Disease / Condition</b></th>
															<th><b>Judgement</b></th>
															<th><b>Species</b></th>
															<th><b>Date Range</b></th>
															<th><b>Head Count</b></th>
															<th><b>Total Dressed Weight (kg)</b></th>
															<?php if(isset($_POST['search_antemortem_condemnation'])) {?>
													...
													<tbody>
														<?php echo disease_report_postmortem_daily_posms() ?>
													</tbody>
												</table>
									</div>
								</div>	
