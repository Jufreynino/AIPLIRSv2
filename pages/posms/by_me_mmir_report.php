					...
					<div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-350">
						...
						<div class="dropdown-content-body dropdown-scrollable">
							<ul class="media-list">
								...
								<hr style="font-size:20px; margin-top: 5px; background-color:black;">

								<li class="media">
									<div class="media-body">
										<div class="media-title">
											<a href="mid_level.php">
												<span style="font-size: 15px;">Mid Level Disease Reported</span>
											</a>
										</div>
										<span class="float-right text-muted" style="font-size:20px; margin-top: -10px; color:#f56161 !important;"><?php echo count_mid_level() ?></span>
									</div>
								</li>
								<hr style="font-size:20px; margin-top: 5px; background-color:black;">
								...
								<li class="media">
									<div class="media-body">
										<div class="media-title">
											<a href="low_level.php">
												<span style="font-size: 15px;">Low Level Disease Reported</span>
											</a>
										</div>
										<span class="float-right text-muted" style="font-size:20px; margin-top: -10px; color:#f56161 !important;"><?php echo count_low_level() ?></span>
									</div>
								</li>
							</ul>
						</div>
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item">
									<a href="meat_inspector_account.php" class="nav-link">Meat Inspection Officer Accounts 
						...
						<li class="nav-item nav-item-submenu  nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item">
									<a href="by_me_mmir.php" class="nav-link active">By Meat Establishment 
									</a>
								</li>
								<li class="nav-item">
					...
					<div class="col-xl-12">
						<div class="card card-collapsed">
							<div class="card-header header-elements-inline"   style="background-color:#263238; color:white;">
								<h3 class="card-title"> Meat Establishments <p style="font-size:15px; ">In the period of <?php echo date('F d, Y', strtotime($_GET['from'])); ?> to <?php echo date('F d, Y', strtotime($_GET['to'])); ?></p><p><?php echo $_SESSION['region']?></p></h3>
